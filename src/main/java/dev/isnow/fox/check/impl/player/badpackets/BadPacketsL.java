...
public final class BadPacketsL extends Check {
    ...
    public void handle(final Packet packet) {
        if (packet.isRotation()) {
            ...
            final boolean exempt = isExempt(ExemptType.TELEPORT_DELAY, ExemptType.VEHICLE, ExemptType.CREATIVE, ExemptType.JOINED) && (data.getPositionProcessor().getSinceTeleportTicks() > 20);
