...
public class MotionK extends Check {
    ...
    public void handle(Packet packet) {
        if(packet.isFlying() && data.getPositionProcessor().getSinceBlockNearHeadTicks() > 10 && !isExempt(ExemptType.PEARL, ExemptType.NEARCACTUS, ExemptType.TELEPORT, ExemptType.VELOCITY_ON_TICK, ExemptType.FIRE, ExemptType.RESPAWN, ExemptType.JOINED, ExemptType.GHOST_BLOCK)) {
