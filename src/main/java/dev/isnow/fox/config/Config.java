...
public final class Config {
    ...
    public String LOG_FORMAT, ALERT_FORMAT, PREFIX, CLIENT_KICK_MESSAGE, KEY, VPN_MESSAGE, KBTEST, ALERTSON, ANTICRASHKICKEDMESSAGE, ANTICRASHALERT, SCARE, ALERTSOFF, CLICKCOMMAND, VANISHON, VANISHOFF, BROADCASTMESSAGE, ALERT_URL, BAN_URL, DISCORDNAME, IMAGEDISCORD;
